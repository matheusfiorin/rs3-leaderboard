...
const ABILITIES = {
  melee: {
    attack_basic:   { name:{pt:'Ataque',en:'Attack'},               lvl:1,  type:'basic',    desc:{pt:'110-130% de dano. Ataque corpo a corpo b\u00e1sico.',en:'110-130% damage. Basic melee attack.'}, icon:'Slice' },
    assault:        { name:{pt:'Assalto',en:'Assault'},              lvl:3,  type:'enhanced', desc:{pt:'4 golpes de 130-150%. Consome Sede de Sangue para curar.',en:'4 hits of 130-150%. Consumes Bloodlust for healing.'}, icon:'Assault' },
    adaptive_str:   { name:{pt:'Golpe Adaptativo',en:'Adaptive Strike'}, lvl:7, type:'basic', desc:{pt:'2H: AoE at\u00e9 9 alvos. DW: alvo \u00fanico + sangramento.',en:'2H: AoE up to 9 targets. DW: single + bleed.'}, icon:'Smash' },
    rend:           { name:{pt:'Rasgar',en:'Rend'},                  lvl:18, type:'basic',    desc:{pt:'135-165% de dano. Gera 2 cargas de Sede de Sangue.',en:'135-165% damage. Generates 2 Bloodlust stacks.'}, icon:'Sever' },
    fury:           { name:{pt:'F\u00faria',en:'Fury'},              lvl:21, type:'basic',    desc:{pt:'110-130% + 25% chance de cr\u00edtico no pr\u00f3ximo ataque.',en:'110-130% + 25% crit chance on next attack.'}, icon:'Fury' },
    hurricane:      { name:{pt:'Furac\u00e3o',en:'Hurricane'},       lvl:37, type:'enhanced', desc:{pt:'AoE 220-260%. Reseta CD em multi-hit. Apenas 2H.',en:'AoE 220-260%. Resets CD on multi-hit. 2H only.'}, icon:'Hurricane' },
    dismember:      { name:{pt:'Desmembrar',en:'Dismember'},         lvl:50, type:'enhanced', desc:{pt:'Sangramento: 8 golpes. Substitui Massacre.',en:'Bleed: 8 hits. Replaces Slaughter/Massacre.'}, icon:'Dismember' },
    punish:         { name:{pt:'Punir',en:'Punish'},                 lvl:60, type:'basic',    desc:{pt:'110-130%. 2.5x em alvos abaixo de 50% HP.',en:'110-130%. 2.5x on targets below 50% HP.'}, icon:'Punish' },
    berserk:        { name:{pt:'Fren\u00e9tico',en:'Berserk'},       lvl:42, type:'ultimate', desc:{pt:'Dano dobrado por 20s. Custa 100% adrenalina.',en:'Double damage for 20s. Costs 100%.'}, icon:'Berserk' },
  },
  ranged: {
    ranged_basic:   { name:{pt:'Dist\u00e2ncia',en:'Ranged'},        lvl:1,  type:'basic',    desc:{pt:'90-110% de dano. Ataque \u00e0 dist\u00e2ncia b\u00e1sico.',en:'90-110% damage. Basic ranged attack.'}, icon:'Piercing_Shot' },
    snap:           { name:{pt:'Tiro Certeiro',en:'Snap Shot'},       lvl:3,  type:'enhanced', desc:{pt:'145-175% x2 golpes. 25% adrenalina.',en:'145-175% x2 hits. 25% adrenaline.'}, icon:'Snap_Shot' },
    snipe:          { name:{pt:'Emboscada',en:'Snipe'},               lvl:5,  type:'enhanced', desc:{pt:'300-360% dano \u00fanico. CD 1 min.',en:'300-360% single hit. 1min CD.'}, icon:'Snipe' },
    piercing:       { name:{pt:'Tiro Perfurante',en:'Piercing Shot'}, lvl:13, type:'basic',    desc:{pt:'45-55% x2 golpes. Reduz CD do Emboscada.',en:'45-55% x2 hits. Reduces Snipe CD.'}, icon:'Needle_Strike' },
    deadshot:       { name:{pt:'Tiro Mortal',en:'Deadshot'},          lvl:21, type:'ultimate', desc:{pt:'125-145% x5 golpes.',en:'125-145% x5 hits.'}, icon:'Deadshot' },
    binding:        { name:{pt:'Tiro Prendedor',en:'Binding Shot'},   lvl:31, type:'basic',    desc:{pt:'65-75% + atordoa por 3.6s.',en:'65-75% + stun/bind for 3.6s.'}, icon:'Binding_Shot' },
    bombardment:    { name:{pt:'Bombardeio',en:'Bombardment'},        lvl:36, type:'enhanced', desc:{pt:'AoE 220-260% em \u00e1rea 5x5.',en:'AoE 220-260% in 5x5 area.'}, icon:'Bombardment' },
    galeshot:       { name:{pt:'Rajada',en:'Galeshot'},               lvl:58, type:'basic',    desc:{pt:'Aplica buff Ventos Ardentes.',en:'Applies Searing Winds buff.'}, icon:'Dazing_Shot' },
    rapid:          { name:{pt:'Tiro R\u00e1pido',en:'Rapid Fire'},   lvl:62, type:'enhanced', desc:{pt:'Canaliza\u00e7\u00e3o: 8 golpes de 75-85%.',en:'Channel: 8 hits of 75-85%.'}, icon:'Rapid_Fire' },
    ricochet:       { name:{pt:'Ricochete',en:'Ricochet'},            lvl:67, type:'basic',    desc:{pt:'AoE: ricochete em alvos pr\u00f3ximos.',en:'AoE: bounces to nearby targets.'}, icon:'Ricochet' },
  },
  magic: {
    magic_basic:    { name:{pt:'Magia',en:'Magic'},                   lvl:1,  type:'basic',    desc:{pt:'90-110% de dano. Ataque m\u00e1gico b\u00e1sico.',en:'90-110% damage. Basic magic attack.'}, icon:'Wrack' },
    sonic:          { name:{pt:'Onda S\u00f4nica',en:'Sonic Wave'},   lvl:6,  type:'basic',    desc:{pt:'90-110%. Concede Fluxo (reduz custo da pr\u00f3xima habilidade).',en:'90-110%. Grants Flow (reduces next ability cost).'}, icon:'Sonic_Wave' },
    combust:        { name:{pt:'Combust\u00e3o',en:'Combust'},        lvl:10, type:'basic',    desc:{pt:'Queimadura: 10 golpes de ~30% = 300% total.',en:'Burn DoT: 10 hits of ~30% = 300% total.'}, icon:'Combust' },
    omnipower:      { name:{pt:'Onipot\u00eancia',en:'Omnipower'},    lvl:12, type:'ultimate', desc:{pt:'420-500% de dano.',en:'420-500% damage.'}, icon:'Omnipower' },
    dragon_breath:  { name:{pt:'Sopro do Drag\u00e3o',en:'Dragon Breath'}, lvl:19, type:'basic', desc:{pt:'AoE 110-130% em linha. +25% vs alvos queimando.',en:'AoE 110-130% line. +25% vs burning targets.'}, icon:'Dragon_Breath' },
    runic_charge:   { name:{pt:'Carga R\u00fanica',en:'Runic Charge'}, lvl:26, type:'basic',   desc:{pt:'Empodera pr\u00f3xima habilidade. Sem GCD.',en:'Empowers next ability. No GCD.'}, icon:'Surge' },
    impact:         { name:{pt:'Impacto',en:'Impact'},                lvl:40, type:'basic',    desc:{pt:'65-75% + atordoa 1.2s.',en:'65-75% + stun 1.2s.'}, icon:'Impact' },
    chain:          { name:{pt:'Corrente',en:'Chain'},                lvl:45, type:'basic',    desc:{pt:'AoE: 70-90% + 2 pr\u00f3ximos. Compartilha 30% da pr\u00f3xima habilidade.',en:'AoE: 70-90% + 2 nearby. Shares 30% of next ability.'}, icon:'Chain' },
    wild_magic:     { name:{pt:'Magia Selvagem',en:'Wild Magic'},     lvl:55, type:'enhanced', desc:{pt:'125-155% x2 golpes. 25% adrenalina.',en:'125-155% x2 hits. 25% adrenaline.'}, icon:'Wild_Magic' },
    conc_blast:     { name:{pt:'Explos\u00e3o Concentrada',en:'Concentrated Blast'}, lvl:66, type:'basic', desc:{pt:'35% x3 canaliza\u00e7\u00e3o. Chance de cr\u00edtico acumulativa.',en:'35% x3 channel. Stacking crit chance.'}, icon:'Concentrated_Blast' },
    sunshine:       { name:{pt:'Luz Solar',en:'Sunshine'},            lvl:50, type:'ultimate', desc:{pt:'+50% de dano por 30s.',en:'+50% damage for 30s.'}, icon:'Sunshine' },
  },
  necro: {
    touch_of_death: { name:{pt:'Toque da Morte',en:'Touch of Death'}, lvl:1, type:'basic',    desc:{pt:'30-120% de dano. Gera cargas de necrose.',en:'30-120% damage. Generates necrosis stacks.'}, icon:'Touch_of_Death' },
    soul_sap:       { name:{pt:'Drenar Alma',en:'Soul Sap'},          lvl:5,  type:'basic',    desc:{pt:'22.8-57%. Gera almas residuais.',en:'22.8-57%. Generates residual souls.'}, icon:'Soul_Sap' },
    spectral_scythe:{ name:{pt:'Foice Espectral',en:'Spectral Scythe'}, lvl:10, type:'basic',  desc:{pt:'AoE em cone frontal, 3 usos.',en:'AoE in frontal cone, 3 recasts.'}, icon:'Spectral_Scythe' },
    finger_of_death:{ name:{pt:'Dedo da Morte',en:'Finger of Death'}, lvl:12, type:'enhanced', desc:{pt:'50-250%. Consome necrose (custo reduzido).',en:'50-250%. Consumes necrosis (reduced cost).'}, icon:'Finger_of_Death' },
    blood_siphon:   { name:{pt:'Sif\u00e3o de Sangue',en:'Blood Siphon'}, lvl:20, type:'basic', desc:{pt:'36-180%. Cura por hit em AoE.',en:'36-180%. Heal per hit on AoE.'}, icon:'Blood_Siphon' },
    bloat:          { name:{pt:'Incha\u00e7o',en:'Bloat'},            lvl:24, type:'basic',    desc:{pt:'Sangramento: 4 golpes em 6s.',en:'Bleed: 4 hits over 6s.'}, icon:'Bloat' },
    volley_of_souls:{ name:{pt:'Rajada de Almas',en:'Volley of Souls'}, lvl:30, type:'enhanced', desc:{pt:'4 golpes. Consome almas residuais.',en:'4 hits. Consumes residual souls.'}, icon:'Volley_of_Souls' },
    command_skel:   { name:{pt:'Comandar Esqueleto',en:'Command Skeleton'}, lvl:32, type:'basic', desc:{pt:'Invoca esqueleto para ataques extras.',en:'Summon skeleton for extra hits.'}, icon:'Command_Skeleton_Warrior' },
    death_skulls:   { name:{pt:'Cr\u00e2nios da Morte',en:'Death Skulls'}, lvl:40, type:'enhanced', desc:{pt:'4 golpes ricocheteantes de 45-135%.',en:'Bouncing 4 hits of 45-135%.'}, icon:'Death_Skulls' },
    living_death:   { name:{pt:'Morte Viva',en:'Living Death'},       lvl:50, type:'ultimate', desc:{pt:'Dedo da Morte gr\u00e1tis por 30s.',en:'Free Finger of Death for 30s.'}, icon:'Living_Death' },
  },
};
...
function getGearForLevel(style, level) {
  ...
  let best = tiers[0];
  for (const g of tiers) { if (g.minLvl <= level) best = g; }
  return best;
}
...
function getMeleeBars(a, lvl) {
  const s=[], ao=[];
  if(lvl>=50) s.push(a.dismember); if(lvl>=3) s.push(a.assault); if(lvl>=21) s.push(a.fury);
  if(lvl>=18) s.push(a.rend); if(lvl>=7) s.push(a.adaptive_str); s.push(a.attack_basic); if(lvl>=60) s.push(a.punish);
  if(lvl>=37) ao.push(a.hurricane); if(lvl>=3) ao.push(a.assault); if(lvl>=7) ao.push(a.adaptive_str);
  if(lvl>=50) ao.push(a.dismember); if(lvl>=21) ao.push(a.fury); if(lvl>=18) ao.push(a.rend); ao.push(a.attack_basic);
  return { single:s.slice(0,9), aoe:ao.slice(0,9) };
}
function getRangedBars(a, lvl) {
  const s=[], ao=[];
  if(lvl>=62) s.push(a.rapid); if(lvl>=3) s.push(a.snap); if(lvl>=5) s.push(a.snipe);
  if(lvl>=13) s.push(a.piercing); if(lvl>=58) s.push(a.galeshot); if(lvl>=31) s.push(a.binding); s.push(a.ranged_basic);
  if(lvl>=36) ao.push(a.bombardment); if(lvl>=67) ao.push(a.ricochet); if(lvl>=3) ao.push(a.snap);
  if(lvl>=62) ao.push(a.rapid); if(lvl>=13) ao.push(a.piercing); if(lvl>=5) ao.push(a.snipe); ao.push(a.ranged_basic);
  return { single:s.slice(0,9), aoe:ao.slice(0,9) };
}
function getMagicBars(a, lvl) {
  const s=[], ao=[];
  if(lvl>=55) s.push(a.wild_magic); if(lvl>=66) s.push(a.conc_blast); if(lvl>=19) s.push(a.dragon_breath);
  if(lvl>=6) s.push(a.sonic); if(lvl>=10) s.push(a.combust); s.push(a.magic_basic); if(lvl>=40) s.push(a.impact); if(lvl>=26) s.push(a.runic_charge);
  if(lvl>=19) ao.push(a.dragon_breath); if(lvl>=45) ao.push(a.chain); if(lvl>=55) ao.push(a.wild_magic);
  if(lvl>=10) ao.push(a.combust); if(lvl>=6) ao.push(a.sonic); ao.push(a.magic_basic); if(lvl>=26) ao.push(a.runic_charge);
  return { single:s.slice(0,9), aoe:ao.slice(0,9) };
}
function getNecroBars(a, lvl) {
  const s=[], ao=[];
  if(lvl>=40) s.push(a.death_skulls); if(lvl>=30) s.push(a.volley_of_souls); if(lvl>=12) s.push(a.finger_of_death);
  if(lvl>=24) s.push(a.bloat); if(lvl>=20) s.push(a.blood_siphon); if(lvl>=5) s.push(a.soul_sap); s.push(a.touch_of_death); if(lvl>=32) s.push(a.command_skel);
  if(lvl>=10) ao.push(a.spectral_scythe); if(lvl>=40) ao.push(a.death_skulls); if(lvl>=30) ao.push(a.volley_of_souls);
  if(lvl>=20) ao.push(a.blood_siphon); if(lvl>=12) ao.push(a.finger_of_death); if(lvl>=24) ao.push(a.bloat); if(lvl>=5) ao.push(a.soul_sap); ao.push(a.touch_of_death);
  return { single:s.slice(0,9), aoe:ao.slice(0,9) };
}
  ...
  el.innerHTML = players.map((p, pi) => {
    ...
    return `<div class="combat-player-col ${cls}">
      ...
      ${styles.map(style => {
        ...
        let level = 1;
        for (const sid of info.skillIds) { const sk = p.skills[sid]; if (sk && sk.level > level) level = sk.level; }
...
function renderBar(abilities, lang) {
  return abilities.map((ab, i) => {
    ...
    const typeName = ab.type === 'enhanced' ? (lang==='pt'?'Aprimorada':'Enhanced') : ab.type === 'ultimate' ? 'Ultimate' : (lang==='pt'?'B\u00e1sica':'Basic');
