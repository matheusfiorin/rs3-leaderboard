...
const LANG = {
  pt: {
    ...
    tierLockedCombat: "Bloqueado — Combate 95+ recomendado",
    notifTitle: "Notificações",
    notifToday: "Hoje",
    notifEmpty: "Nada novo hoje",
    notifMarkAllRead: "Marcar tudo como lido",
    notifOpenAria: "Abrir notificações",
  },
  ...
  en: {
    ...
    tierEarly: "Early Game",
    tierMid: "Mid Game",
    tierEnd: "End Game",
    tierDone: "done",
    tierLocked: "Locked",
    tierLockedCombat: "Locked — Combat 95+ recommended",
    notifTitle: "Notifications",
    notifToday: "Today",
    notifEmpty: "Nothing new today",
    notifMarkAllRead: "Mark all read",
    notifOpenAria: "Open notifications",
  },
};
