    ...
    blocks: [
      {
        time: '0:00 - 0:30',
        icon: '\u2692',
        title: { pt: 'Prepara\u00e7\u00e3o \u2014 Equipamento & Suprimentos', en: 'Preparation \u2014 Gear & Supplies' },
        desc: {
        ...
        tips: { pt: ['Decxus: Metalurgia 35\u219236, CF 42\u219243','Compraram comida e runas pro DG'], en: ['Decxus: Smithing 35\u219236, HP 42\u219243','Bought food and runes for DG'] },
        rewards: { pt: 'Equipamento preparado, suprimentos prontos', en: 'Gear ready, supplies stocked' },
        done: true,
      },
      {
        time: '0:30 - 3:00',
        ...
        rewards: { pt: 'XP de DG, tokens de DG, XP de combate, kills de bosses', en: 'DG XP, DG tokens, combat XP, boss kills' },
        done: true,
      },
    ],
    summary: {
      pt: {
        questsTarget: [],
        xpExpected: 'Fiorovizk: +89K XP (11 niveis) | Decxus: +30K XP (18 niveis)',
        gpExpected: 'Loot de Dungeoneering + min\u00e9rios da minera\u00e7\u00e3o',
        funFactor: 'Kalaboss duo por 2h30, 4 bosses cada, Decxus andares 9-11',
      },
      en: {
        questsTarget: [],
        xpExpected: 'Fiorovizk: +89K XP (11 levels) | Decxus: +30K XP (18 levels)',
        gpExpected: 'Dungeoneering loot + mining ores',
        funFactor: 'Kalaboss duo for 2h30, 4 boss kills each, Decxus floors 9-11',
      },
    },
  },
];
